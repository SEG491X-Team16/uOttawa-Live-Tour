...
public class TourPathGenerator
{
    ...
    // private string[] buildingNames_EN = {"Tabaret Hall", "Simard and Hamelin Halls", "Perez Hall", "Morisset Library", 
    //                                     "90 University Residence", "University Center", "Faculty of Social Sciences", 
    //                                     "O-Train Station", "Biosciences Complex", "Learning Crossroads", "STEM Complex",
    //                                     "Colonel By Hall", "SITE"};
    // private string[] buildingNames_FR =  {"Pavillon Tabaret", "Pavillons Simard et Hamelin", "Pavillon Pérez", "Bibliothèque Morisset", 
    //                                     "Residence 90 Université", "Centre Universitaire", "Faculté des sciences sociales", 
    //                                     "Station O-Train", "Complexe de Biosciences", "Carrefour des Apprentissages", "Complexe STEM",
    //                                     "Pavillon Colonel By", "EITI"};
    ...
    {
        string[] buildingNames = new string[13] {"Tabaret Hall", "Simard and Hamelin Halls", "Perez Hall", "Morisset Library", 
                                        "90 University Residence", "University Center", "Faculty of Social Sciences", 
                                        "O-Train Station", "Biosciences Complex", "Learning Crossroads", "STEM Complex",
                                        "Colonel By Hall", "SITE"};

        if (LocalizationSettings.SelectedLocale == LocalizationSettings.AvailableLocales.GetLocale("fr")){
            buildingNames  = new string[13] {"Pavillon Tabaret", "Pavillons Simard et Hamelin", "Pavillon Pérez", "Bibliothèque Morisset", 
                                        "Residence 90 Université", "Centre Universitaire", "Faculté des sciences sociales", 
                                        "Station O-Train", "Complexe de Biosciences", "Carrefour des Apprentissages", "Complexe STEM",
                                        "Pavillon Colonel By", "EITI"};
        }
        ...
        Dialogue dia1 = new Dialogue(buildingNames[0], dialogueInfo[Buildings.TBT], dialogAudio[Buildings.TBT]);
        ...
        poi1.BuildingName = buildingNames[0];
        ...
        Dialogue dia2 = new Dialogue(buildingNames[1], dialogueInfo[Buildings.SMD], dialogAudio[Buildings.SMD]);
        ...
        poi2.BuildingName = buildingNames[1];
        ...
        Dialogue dia3 = new Dialogue(buildingNames[2], dialogueInfo[Buildings.PRZ], dialogAudio[Buildings.PRZ]);
        ...
        poi3.BuildingName = buildingNames[2];
        ...
        Dialogue dia4 = new Dialogue(buildingNames[3], dialogueInfo[Buildings.MRT], dialogAudio[Buildings.MRT]);
        ...
        poi4.BuildingName = buildingNames[3];
        ...
        Dialogue dia5 = new Dialogue(buildingNames[4], dialogueInfo[Buildings.Res90U], dialogAudio[Buildings.Res90U]);
        ...
        poi5.BuildingName = buildingNames[4];
        ...
        Dialogue dia6 = new Dialogue(buildingNames[5], dialogueInfo[Buildings.UCU], dialogAudio[Buildings.UCU]);
        ...
        poi6.BuildingName = buildingNames[5];
        ...
        Dialogue dia7 = new Dialogue(buildingNames[6], dialogueInfo[Buildings.FSS], dialogAudio[Buildings.FSS]);
        ...
        poi7.BuildingName = buildingNames[6];
        ...
        Dialogue dia8 = new Dialogue(buildingNames[7], dialogueInfo[Buildings.OTrain], dialogAudio[Buildings.OTrain]);
        ...
        poi8.BuildingName = buildingNames[7];
        ...
        Dialogue dia9 = new Dialogue(buildingNames[8], dialogueInfo[Buildings.BSC], dialogAudio[Buildings.BSC]);
        ...
        poi9.BuildingName = buildingNames[8];
        ...
        Dialogue dia10 = new Dialogue(buildingNames[9], dialogueInfo[Buildings.CRX], dialogAudio[Buildings.CRX]);
        ...
        poi10.BuildingName = buildingNames[9];
        ...
        Dialogue dia11 = new Dialogue(buildingNames[10], dialogueInfo[Buildings.STEM], dialogAudio[Buildings.STEM]);
        ...
        poi11.BuildingName = buildingNames[10];
        ...
        Dialogue dia12 = new Dialogue(buildingNames[11], dialogueInfo[Buildings.CBY], dialogAudio[Buildings.CBY]);
        ...
        poi12.BuildingName = buildingNames[11];
        ...
        Dialogue dia13 = new Dialogue(buildingNames[12], dialogueInfo[Buildings.SITE], dialogAudio[Buildings.SITE]);
        ...
        poi13.BuildingName = buildingNames[12];
